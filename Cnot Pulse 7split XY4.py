# -*- coding: utf-8 -*-
"""
Created on Mon Jul 25 05:27:51 2022
...
cr22p_d0_u1=pulse.library.GaussianSquare(cr90d0duration, cr90d0amp/4, cr90d0sigma, cr90d0width,name="CR22_d0_u1")

cr11p_d0_u1=pulse.library.GaussianSquare(cr90d0duration, cr90d0amp/8, cr90d0sigma, cr90d0width,name="CR11_d0_u1")
...
cr22p_u1=pulse.library.GaussianSquare(cr90duration, cr90amp/4, cr90sigma, cr90width,name="CR22p_u1")

cr11p_u1=pulse.library.GaussianSquare(cr90duration, cr90amp/8, cr90sigma, cr90width,name="CR11p_u1")
...
cr22m_d0_u1=pulse.library.GaussianSquare(cr90d0duration, cr90md0amp/4, cr90d0sigma, cr90d0width,name="CR22m_d0_u1")

cr11m_d0_u1=pulse.library.GaussianSquare(cr90d0duration, cr90md0amp/8, cr90d0sigma, cr90d0width,name="CR11m_d0_u1")
...
cr22m_u1=pulse.library.GaussianSquare(cr90duration, cr90mamp/4, cr90sigma, cr90width,name="CR22_d0_u1")

cr11m_u1=pulse.library.GaussianSquare(cr90duration, cr90mamp/8, cr90sigma, cr90width,name="CR11_d0_u1")
...
with pulse.build(backend,name='cr45') as cr45p1:
...
with pulse.build(backend,name='cr22') as cr22p1:
    pulse.play(cr22p_d0_u1,dc0)
    pulse.play(cr22p_u1, cc1)
    pulse.delay(1584,dc1)

with pulse.build(backend,name='cr11') as cr11p1:
    pulse.play(cr11p_d0_u1,dc0)
    pulse.play(cr11p_u1, cc1)
    pulse.delay(1584,dc1)
...
with pulse.build(backend,name='cr45m') as cr45m1:            
    pulse.play(cr45m_d0_u1,dc0)
    pulse.play(cr45m_u1,cc1)    
    pulse.delay(1584,dc1)

with pulse.build(backend,name='cr22m') as cr22m1:            
    pulse.play(cr22m_d0_u1,dc0)
    pulse.play(cr22m_u1,cc1)    
    pulse.delay(1584,dc1)
    
with pulse.build(backend,name='cr11m') as cr11m1:            
    pulse.play(cr11m_d0_u1,dc0)
    pulse.play(cr11m_u1,cc1)    
    pulse.delay(1584,dc1)
...
cr45_p1=Gate(name='cr45p1', label='cr45', num_qubits=2, params=[])
cr22_p1=Gate(name='cr22p1', label='cr22', num_qubits=2, params=[])
cr11_p1=Gate(name='cr11p1', label='cr11', num_qubits=2, params=[])
m_X=Gate(name='X_mid', label='X', num_qubits=2, params=[])
cr45_m1=Gate(name='cr45m1', label='-cr45', num_qubits=2, params=[])
cr22_m1=Gate(name='cr22m1', label='-cr22', num_qubits=2, params=[])
cr11_m1=Gate(name='cr11m1', label='-cr11', num_qubits=2, params=[])
...
qc.add_calibration('cr45p1', [0,1], cr45p1,[])
qc.add_calibration('cr22p1', [0,1], cr22p1,[])
qc.add_calibration('cr11p1', [0,1], cr11p1,[])
#qc.add_calibration('cr22p2', [0,1], cr22p2,[])
qc.add_calibration('X_mid', [0,1], X,[])
qc.add_calibration('cr45m1', [0,1], cr45m1,[])
qc.add_calibration('cr22m1', [0,1], cr22m1,[])
qc.add_calibration('cr11m1', [0,1], cr11m1,[])
